...
all: uspsv1.o uspsv2.o uspsv3.o uspsv4.o p1fxns.o uqueue.o iterator.o linkedlist.o arraylist.o
	gcc -W -Wall -g -o uspsv1 uspsv1.c p1fxns.o arraylist.o
	gcc -W -Wall -g -o uspsv2 uspsv2.c p1fxns.o arraylist.o
